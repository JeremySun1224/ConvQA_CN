    ...
    for model_recover_path in [args.model_path.strip()]:
        ...
        with open(args.input_file, "r", encoding="utf-8") as reader:
            ...
            for example in examples:
                passages.append(example["passages"])
            ...
            while next_i < len(input_lines):
                ...
                with torch.no_grad():
                    ...
                    for i in range(len(buf)):
                        ...
                        if args.do_rule:
                            output_tokens = output_sequence.split(" ")
                            paragraph = passages[buf_id[i]]
        ...
        with open(fn_out, "w", encoding="utf-8") as writer, open(args.input_file, "r", encoding="utf-8") as reader:
            examples = []
            qids = []
            for line in reader:
                examples.append(json.loads(line))
