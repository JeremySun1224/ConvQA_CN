...
class Seq2seqDatasetForBert(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.span_len > 1:
            ...
            return source_ids, target_ids, pseudo_ids, num_source_tokens, num_target_tokens, start_position, end_position, ans_choice, span_ids
        else:
            return source_ids, target_ids, pseudo_ids, num_source_tokens, num_target_tokens, start_position, end_position, ans_choice
