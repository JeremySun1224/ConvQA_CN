...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            # start_positions: answer span begin at this position
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    eval_sampler = SequentialSampler(dataset)  # Samples elements sequentially, always in the same order.
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            ...
            example_indices = batch[3]  # start_positions
            outputs = model(**inputs)  # the model is AutoModelForConversationalQuestionAnswering.
...
def main():
    ...
    # parser.add_argument("--fuse_bert", type=str, default='dym',
    #                     help="dynamic weight fusion")
    # parser.add_argument('--')
    ...
    if args.doc_stride >= args.max_seq_length - args.max_query_length:
        logger.warning(
            ...
            "examples. This could result in errors when building features from the examples. Please reduce the doc_stride "
            "or increase the maximum length to ensure the features are correctly built."
        )
